...
const FIELD_CHECKS: { field: string; label: string; patterns: RegExp[] }[] = [
  ...
  { field: 'family_history', label: '가족력', patterns: [/가족력|부모.*질환|아버지|어머니|가족.*병|암|당뇨|고혈압|심장|심혈관|뇌혈관|없음|없어|없습니다/] },
  { field: 'current_condition', label: '현재 건강상태', patterns: [/현재.*질환|앓고|건강.*상태|건강.*이상|이상.*없|질환.*없|건강합니다|건강해|건강함|특이.*없|이상없|없음|고혈압|당뇨|심혈관|암.*이력/] },
